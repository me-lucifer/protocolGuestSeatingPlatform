      ...
      <div className="max-w-3xl mx-auto">
        <Card className="shadow-none border-0">
          <CardHeader className="text-center space-y-4">
            <CardDescription className="text-lg">You are invited to the</CardDescription>
          ...
          <CardContent className="mt-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="flex flex-col items-center justify-center bg-muted/30 p-6 rounded-lg">
                <p className="text-sm font-semibold text-muted-foreground mb-4">Please present at entrance</p>
                 <div className="w-40 h-40 mb-4 bg-background flex items-center justify-center rounded-md border shadow-inner">
                    <div className="flex flex-col items-center text-muted-foreground">
                        ...
                        <p className="mt-2 text-xs font-semibold">QR Code</p>
                    </div>
                </div>
            ...
            <div className="text-center text-muted-foreground">
              <p className="font-semibold text-lg">Event Details</p>
              <p className="mt-2 max-w-2xl mx-auto">
                It is with great pleasure that we invite you to the {event.name}, a gathering of distinguished leaders and diplomats to celebrate international cooperation and shared progress.
              </p>
            </div>
             <p className="text-center text-xs text-muted-foreground mt-8 no-print">
                This printable view is part of a prototype. You can close this tab to return to the application.
              </p>
          </CardContent>
        </Card>
      </div>
